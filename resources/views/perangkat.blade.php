...
<div class="max-w-6xl mx-auto py-10 px-4">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
        <!-- Card perangkat desa dengan link ke detail -->
        <a href="{{ route('perangkat.detail', ['id' => 1]) }}" class="bg-white rounded-xl shadow-lg p-6 flex flex-col items-center transition-transform duration-300 hover:-translate-y-2 hover:shadow-2xl cursor-pointer" data-aos="fade-up">
        ...
        <a href="{{ route('perangkat.detail', ['id' => 2]) }}" class="bg-white rounded-xl shadow-lg p-6 flex flex-col items-center transition-transform duration-300 hover:-translate-y-2 hover:shadow-2xl cursor-pointer" data-aos="fade-up" data-aos-delay="50">
        ...
        <a href="{{ route('perangkat.detail', ['id' => 3]) }}" class="bg-white rounded-xl shadow-lg p-6 flex flex-col items-center transition-transform duration-300 hover:-translate-y-2 hover:shadow-2xl cursor-pointer" data-aos="fade-up" data-aos-delay="100">
        ...
        <a href="{{ route('perangkat.detail', ['id' => 4]) }}" class="bg-white rounded-xl shadow-lg p-6 flex flex-col items-center transition-transform duration-300 hover:-translate-y-2 hover:shadow-2xl cursor-pointer" data-aos="fade-up" data-aos-delay="150">
        ...
        <a href="{{ route('perangkat.detail', ['id' => 5]) }}" class="bg-white rounded-xl shadow-lg p-6 flex flex-col items-center transition-transform duration-300 hover:-translate-y-2 hover:shadow-2xl cursor-pointer" data-aos="fade-up" data-aos-delay="200">
        ...
        <a href="{{ route('perangkat.detail', ['id' => 6]) }}" class="bg-white rounded-xl shadow-lg p-6 flex flex-col items-center transition-transform duration-300 hover:-translate-y-2 hover:shadow-2xl cursor-pointer" data-aos="fade-up" data-aos-delay="250">
        ...
        <a href="{{ route('perangkat.detail', ['id' => 7]) }}" class="bg-white rounded-xl shadow-lg p-6 flex flex-col items-center transition-transform duration-300 hover:-translate-y-2 hover:shadow-2xl cursor-pointer" data-aos="fade-up" data-aos-delay="300">
        ...
        <a href="{{ route('perangkat.detail', ['id' => 8]) }}" class="bg-white rounded-xl shadow-lg p-6 flex flex-col items-center transition-transform duration-300 hover:-translate-y-2 hover:shadow-2xl cursor-pointer" data-aos="fade-up" data-aos-delay="350">
        ...
        <a href="{{ route('perangkat.detail', ['id' => 9]) }}" class="bg-white rounded-xl shadow-lg p-6 flex flex-col items-center transition-transform duration-300 hover:-translate-y-2 hover:shadow-2xl cursor-pointer" data-aos="fade-up" data-aos-delay="400">
        ...
        <a href="{{ route('perangkat.detail', ['id' => 10]) }}" class="bg-white rounded-xl shadow-lg p-6 flex flex-col items-center transition-transform duration-300 hover:-translate-y-2 hover:shadow-2xl cursor-pointer" data-aos="fade-up" data-aos-delay="450">
