...
<body class="bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] flex p-6 lg:p-8 items-center lg:justify-center min-h-screen flex-col">
    <!-- ...existing code... -->
    <div class="z-10 text-center" data-aos="fade-down">
        <h1 class="text-5xl md:text-6xl font-bold mb-4 drop-shadow-lg animate__animated animate__fadeInDown">SMK Modern Nusantara</h1>
        <p class="text-xl md:text-2xl mb-8 animate__animated animate__fadeInUp">Membangun Generasi Unggul, Berkarakter, dan Berprestasi</p>
        <a href="#fitur" class="px-8 py-3 bg-white text-indigo-600 font-bold rounded-full shadow-lg transition hover:scale-105 hover:bg-indigo-50 animate-bounce">Jelajahi Sekolah</a>
    </div>
    <div class="absolute bottom-0 left-0 w-full flex justify-center pb-8 animate__animated animate__fadeInUp">
        <span class="text-white text-lg">Tahun Ajaran 2025/2026 - Pendaftaran Siswa Baru Dibuka!</span>
    </div>
    </section>

    <!-- Fitur Sekolah -->
    <section id="fitur" class="py-20 bg-white dark:bg-[#161615]">
        <div class="container mx-auto px-6">
            <h2 class="text-3xl font-bold text-center mb-12" data-aos="fade-up">Fitur Unggulan Sekolah</h2>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="glass rounded-xl p-8 shadow-lg flex flex-col items-center" data-aos="fade-right">
                    <img src="https://img.icons8.com/color/96/000000/classroom.png" alt="Fasilitas" class="mb-4 animate__animated animate__zoomIn" />
                    <h3 class="text-xl font-semibold mb-2">Fasilitas Modern</h3>
                    <p class="text-gray-700 text-center">Ruang kelas ber-AC, laboratorium komputer, perpustakaan digital, dan area olahraga lengkap.</p>
                </div>
                <div class="glass rounded-xl p-8 shadow-lg flex flex-col items-center" data-aos="fade-up">
                    <img src="https://img.icons8.com/color/96/000000/teacher.png" alt="Guru" class="mb-4 animate__animated animate__zoomIn" />
                    <h3 class="text-xl font-semibold mb-2">Tenaga Pengajar Profesional</h3>
                    <p class="text-gray-700 text-center">Guru berpengalaman, ramah, dan selalu mendukung perkembangan siswa.</p>
                </div>
                <div class="glass rounded-xl p-8 shadow-lg flex flex-col items-center" data-aos="fade-left">
                    <img src="https://img.icons8.com/color/96/000000/trophy.png" alt="Prestasi" class="mb-4 animate__animated animate__zoomIn" />
                    <h3 class="text-xl font-semibold mb-2">Prestasi Gemilang</h3>
                    <p class="text-gray-700 text-center">Juara lomba tingkat nasional, internasional, dan alumni sukses di berbagai bidang.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <!-- Footer -->
    <footer class="bg-indigo-600 text-white py-8 mt-20">
        <div class="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center">
            <div class="mb-4 md:mb-0">
                <span class="font-bold text-lg">SMK Modern Nusantara</span> <br>
                <span class="text-sm">Jl. Pendidikan No. 123, Jakarta</span>
            </div>
            <div class="flex gap-4">
                <a href="#" class="hover:text-indigo-200 transition">Beranda</a>
                <a href="#fitur" class="hover:text-indigo-200 transition">Fitur</a>
                <a href="#" class="hover:text-indigo-200 transition">Kontak</a>
            </div>
            <div class="text-sm mt-4 md:mt-0">&copy; 2025 SMK Modern Nusantara. All rights reserved.</div>
        </div>
    </footer>
    <script>
        AOS.init({
