...
<div class="max-w-3xl mx-auto py-10 px-4">
    ...
    <div class="bg-white rounded-xl shadow-lg p-8" data-aos="fade-up">
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="{{ route('admin.berita.create') }}" class="bg-yellow-600 text-white px-4 py-2 rounded font-semibold shadow hover:bg-yellow-700 transition">Tambah Berita</a>
        </div>
            ...
            <table class="min-w-full text-left">
                ...
                <tbody>
                    ...
                    <tr class="border-b hover:bg-yellow-50">
                        ...
                        <td class="py-2">{{ \Carbon\Carbon::parse($berita->tanggal)->translatedFormat('d F Y') }}</td>
                        <td class="py-2 flex gap-2">
                            <a href="{{ route('admin.berita.edit', $berita->id) }}" class="bg-blue-500 text-white px-2 py-1 rounded text-xs hover:bg-blue-600 transition">Edit</a>
                    ...
                    @empty
                    <tr>
                        <td colspan="3" class="text-center text-gray-500">Belum ada berita.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
