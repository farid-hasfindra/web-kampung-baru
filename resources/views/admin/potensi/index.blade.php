...
<div class="max-w-5xl mx-auto mt-8 p-6 bg-white rounded-xl shadow">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('admin.potensi.create') }}" class="bg-blue-600 text-white px-4 py-2 rounded font-semibold shadow hover:bg-blue-700 transition">Tambah Potensi</a>
    </div>
        ...
        <table class="min-w-full bg-white border rounded-lg">
            ...
            <tbody>
                ...
                <tr class="border-b hover:bg-blue-50">
                    ...
                    <td class="py-2 px-4">
                        <a href="{{ route('admin.potensi.edit', $potensi->id) }}" class="bg-yellow-500 text-white px-3 py-1 rounded shadow hover:bg-yellow-600 transition text-sm">Edit</a>
                        <form action="{{ route('admin.potensi.destroy', $potensi->id) }}" method="POST" class="inline">
                            @csrf
                            @method('DELETE')
