...
<div class="w-full py-10 px-8">
    ...
    <div class="bg-white rounded-xl shadow-lg p-8" data-aos="fade-up">
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="{{ route('galeri.create') }}" class="bg-pink-600 text-white px-4 py-2 rounded font-semibold shadow hover:bg-pink-700 transition">Tambah Foto</a>
        </div>
            ...
            <div class="bg-gray-100 rounded-lg overflow-hidden shadow hover:shadow-lg transition-all duration-300" data-aos="zoom-in">
                ...
                <div class="p-2 flex justify-between items-center">
                    ...
                    <div class="flex gap-1">
                        <a href="{{ route('galeri.edit', 1) }}" class="bg-blue-500 text-white px-2 py-1 rounded text-xs hover:bg-blue-600 transition">Edit</a>
                        <form action="{{ route('galeri.destroy', 1) }}" method="POST" style="display:inline;">
                            @csrf
                            @method('DELETE')
