...
<div class="max-w-4xl mx-auto py-10 px-4">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        <a href="#" class="bg-blue-50 hover:bg-blue-100 rounded-xl shadow-lg p-6 flex flex-col items-center transition-transform duration-300 hover:-translate-y-2" data-aos="fade-up">
        ...
        <a href="#" class="bg-yellow-50 hover:bg-yellow-100 rounded-xl shadow-lg p-6 flex flex-col items-center transition-transform duration-300 hover:-translate-y-2" data-aos="fade-up" data-aos-delay="100">
        ...
        <a href="#" class="bg-green-50 hover:bg-green-100 rounded-xl shadow-lg p-6 flex flex-col items-center transition-transform duration-300 hover:-translate-y-2" data-aos="fade-up" data-aos-delay="200">
        ...
        <a href="#" class="bg-red-50 hover:bg-red-100 rounded-xl shadow-lg p-6 flex flex-col items-center transition-transform duration-300 hover:-translate-y-2" data-aos="fade-up" data-aos-delay="300">
